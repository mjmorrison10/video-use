...
## Clip 1 — "More Migrants, Fewer Murders"  · 31.2s · `dark_knight.mp3`  *(proven #1 + #4)*
...
- **Point:** Young immigrants prop up Spain's pension system today — but if they're low-skilled with low fertility, immigration isn't a lasting fix for an aging population.
- Structure: Hook (Spain's immigration boom — because they're young — is making the pension system more sustainable right now) → Reinforce (but if you mainly bring in low-skilled immigrants who also have low fertility, immigration is not a long-term solution to rapid aging).

## Clip 4 — "Spain Lost Its Crown?"  · 17.5s · `royalty.mp3`  *(proven #2)*
